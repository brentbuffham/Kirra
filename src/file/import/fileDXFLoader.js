...
import { createDXF3DFace } from "../../entities/meshEntities/drawMeshDXF3DFaces.js";
    ...
    reader.onload = function (event) {
        ...
        dxf.entities.forEach((entity) => {
            ...
            if (entityType === "3dface") {
                const face3d = createDXF3DFace(entity, offsetX, offsetY, entityName);
                if (face3d) {
                    entityGroups[entityType].add(face3d);
                }
            }
        });
