...
export function drawMeshCircleHole(scene, color, materialType, uuid, blastName, name, collarXYZ, intervalXYZ, toeXYZ, diameter, thickness, radialSegments, tubularSegments, arc) {
	...
	hole.add(createTorus(color ? color : colourSpectrum[0], materialType, collarXYZ, diameter, thickness, radialSegments, tubularSegments, arc));
	hole.add(createCylinder(color ? color : colourSpectrum[1], materialType, collarXYZ, intervalXYZ, thickness, radialSegments));
	hole.add(createTorus(color ? color : colourSpectrum[2], materialType, intervalXYZ, diameter / 2, thickness, radialSegments, tubularSegments, arc));
	hole.add(createCylinder(color ? color : colourSpectrum[3], materialType, intervalXYZ, toeXYZ, thickness, radialSegments));
	hole.add(createTorus(color ? color : colourSpectrum[4], materialType, toeXYZ, diameter / 2, thickness, radialSegments, tubularSegments, arc));
	hole.name = name;
	hole.userData = {
		uuid: uuid,
		blastName: blastName,
