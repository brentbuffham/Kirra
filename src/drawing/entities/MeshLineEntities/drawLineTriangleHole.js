...
import { createAnyShape } from "../../shapes/createAnyShape.js";

export function drawLineTriangleHole(scene, color, name, collarXYZ, intervalXYZ, toeXYZ, diameter, lineWidth, dashArray, dashOffset, dashRatio, opacity, sizeAttenuation, isFilled) {
